...
const TYPE_BADGE_CLASSES: Record<string, string> = {
  ...
  Word: 'bg-blue-100 text-blue-700 dark:bg-blue-950 dark:text-blue-400 border-transparent',
  Excel: 'bg-green-100 text-green-700 dark:bg-green-950 dark:text-green-400 border-transparent',
  Text: 'bg-gray-100 text-gray-600 dark:bg-gray-800 dark:text-gray-400 border-transparent',
}
