        ...
        <div className="mt-6 rounded-2xl bg-white border border-black/5 p-6">
          <div className="flex items-center justify-between flex-wrap gap-4">
            ...
            <div className="flex items-center gap-2">
              ...
              {!!data && (
                <Badge className={cn("hover:bg-black/5", mttrTrend <= 0 ? "bg-gray-100 text-gray-600" : "bg-gray-100 text-gray-600")}>
                  {mttrTrend <= 0 ? (
              ...
              {(data?.recentActivity || []).slice(0, 15).map((ev) => {
                ...
                return (
                  <div key={ev.id} className="flex items-start justify-between gap-3 rounded-xl border border-black/5 p-4">
                    ...
                    <div className={cn("text-xs px-2 py-1 rounded-full", isCompleted ? "bg-gray-100 text-gray-600" : "bg-black/5 text-black/70")}>
