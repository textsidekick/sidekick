...
export default function Privacy() {
  return (
    <div style={{ fontFamily: "Inter, system-ui, sans-serif", background: "#F7F3EC", minHeight: "100vh" }}>
      {/* Nav */}
      <div style={{ position: "sticky", top: 0, zIndex: 50, padding: "16px 24px", borderBottom: "1px solid rgba(28,26,22,0.08)", background: "rgba(247,243,236,0.96)", backdropFilter: "blur(12px)" }}>
        <a href="/" style={{ display: "inline-flex", alignItems: "center", gap: 6, textDecoration: "none", color: "#1C1A16", fontSize: 15, fontWeight: 600, letterSpacing: "-0.01em", opacity: 0.85, transition: "opacity 0.15s" }}>
      ...
      <main style={{ paddingTop: "72px", paddingBottom: "80px" }}>
        <div style={{ maxWidth: 720, margin: "0 auto", padding: "0 24px" }}>
          ...
          <div style={{ marginBottom: "48px" }}>
            <h1 style={{ fontSize: "clamp(36px, 5vw, 52px)", fontWeight: 700, color: "#1C1A16", marginBottom: "12px", letterSpacing: "-0.03em", lineHeight: 1.1 }}>
              Privacy Policy
            </h1>
          ...
          <div style={{ color: "rgba(28,26,22,0.7)", fontSize: "16px", lineHeight: "1.8" }}>
            ...
            <h2 style={{ fontSize: "22px", fontWeight: 700, color: "#1C1A16", marginTop: "48px", marginBottom: "16px", letterSpacing: "-0.02em" }}>1. Information We Collect</h2>

            <h3 style={{ fontSize: "17px", fontWeight: 600, color: "#1C1A16", marginTop: "24px", marginBottom: "10px" }}>Information You Provide</h3>
            ...
            <h3 style={{ fontSize: "17px", fontWeight: 600, color: "#1C1A16", marginTop: "24px", marginBottom: "10px" }}>Information Collected Automatically</h3>
            <ul style={{ paddingLeft: "22px", marginBottom: "16px" }}>
            ...
            <h2 style={{ fontSize: "22px", fontWeight: 700, color: "#1C1A16", marginTop: "48px", marginBottom: "16px", letterSpacing: "-0.02em" }}>2. How We Use Your Information</h2>
            ...
            <h2 style={{ fontSize: "22px", fontWeight: 700, color: "#1C1A16", marginTop: "48px", marginBottom: "16px", letterSpacing: "-0.02em" }}>3. Information Sharing</h2>
            <p style={{ marginBottom: "12px" }}>We do not sell your personal information. We may share your information with:</p>
            <ul style={{ paddingLeft: "22px", marginBottom: "16px" }}>
              <li><strong style={{ color: "#1C1A16", fontWeight: 600 }}>Service Providers:</strong> Third parties who help us operate our services (cloud hosting, SMS providers, analytics)</li>
              <li><strong style={{ color: "#1C1A16", fontWeight: 600 }}>Your Employer:</strong> If you use Sidekick through your employer, certain usage data may be shared with them</li>
              <li><strong style={{ color: "#1C1A16", fontWeight: 600 }}>Legal Requirements:</strong> When required by law or to protect our rights</li>
            </ul>

            <h2 style={{ fontSize: "22px", fontWeight: 700, color: "#1C1A16", marginTop: "48px", marginBottom: "16px", letterSpacing: "-0.02em" }}>4. Data Security</h2>
            ...
            <h2 style={{ fontSize: "22px", fontWeight: 700, color: "#1C1A16", marginTop: "48px", marginBottom: "16px", letterSpacing: "-0.02em" }}>5. Data Retention</h2>
            <p>
            ...
            <h2 style={{ fontSize: "22px", fontWeight: 700, color: "#1C1A16", marginTop: "48px", marginBottom: "16px", letterSpacing: "-0.02em" }}>6. Your Rights</h2>
            ...
            <h2 style={{ fontSize: "22px", fontWeight: 700, color: "#1C1A16", marginTop: "48px", marginBottom: "16px", letterSpacing: "-0.02em" }}>7. California Privacy Rights (CCPA)</h2>
            <p>
            ...
            <h2 style={{ fontSize: "22px", fontWeight: 700, color: "#1C1A16", marginTop: "48px", marginBottom: "16px", letterSpacing: "-0.02em" }}>8. Children's Privacy</h2>
            <p>
              Our services are not intended for individuals under 18 years of age. We do not knowingly collect personal information from children.
            </p>

            <h2 style={{ fontSize: "22px", fontWeight: 700, color: "#1C1A16", marginTop: "48px", marginBottom: "16px", letterSpacing: "-0.02em" }}>9. Changes to This Policy</h2>
            <p>
              We may update this Privacy Policy from time to time. We will notify you of any changes by posting the new policy on this page and updating the "Last updated" date.
            </p>

            <h2 style={{ fontSize: "22px", fontWeight: 700, color: "#1C1A16", marginTop: "48px", marginBottom: "16px", letterSpacing: "-0.02em" }}>10. Contact Us</h2>
      ...
      <div style={{ textAlign: "center", padding: "32px 20px", borderTop: "1px solid rgba(28,26,22,0.08)" }}>
        <a href="/" style={{ color: "#C96442", textDecoration: "none", fontWeight: 500, fontSize: "15px" }}>← Back to Sidekick</a>
