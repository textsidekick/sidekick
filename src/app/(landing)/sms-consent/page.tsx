          ...
          <div className="row justify-content-center">
            <div className="col-lg-8">
              ...
              <div style={{
                ...
                <p style={{ color: '#1A1615cc', fontSize: '16px', lineHeight: '1.8', marginBottom: '16px' }}>
                  We respect your privacy. Your phone number and message content will be handled according to our <a href="/privacy" style={{ color: '#3B82F6' }}>Privacy Policy</a>. We do not sell your information to third parties.
                </p>
