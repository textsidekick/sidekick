      ...
      <main style={{ paddingTop: "72px", paddingBottom: "80px" }}>
        <div style={{ maxWidth: 720, margin: "0 auto", padding: "0 24px" }}>
          ...
          <div style={{ color: "rgba(28,26,22,0.7)", fontSize: "16px", lineHeight: "1.8" }}>
            ...
            <h2 style={{ fontSize: "22px", fontWeight: 700, color: "#1C1A16", marginTop: "48px", marginBottom: "16px", letterSpacing: "-0.02em" }}>1. Acceptance of Terms</h2>
            <p>
            ...
            <h2 style={{ fontSize: "22px", fontWeight: 700, color: "#1C1A16", marginTop: "48px", marginBottom: "16px", letterSpacing: "-0.02em" }}>2. Description of Service</h2>
            ...
            <h2 style={{ fontSize: "22px", fontWeight: 700, color: "#1C1A16", marginTop: "48px", marginBottom: "16px", letterSpacing: "-0.02em" }}>3. User Accounts</h2>
            <p>
            ...
            <h2 style={{ fontSize: "22px", fontWeight: 700, color: "#1C1A16", marginTop: "48px", marginBottom: "16px", letterSpacing: "-0.02em" }}>4. Acceptable Use</h2>
            ...
            <h2 style={{ fontSize: "22px", fontWeight: 700, color: "#1C1A16", marginTop: "48px", marginBottom: "16px", letterSpacing: "-0.02em" }}>5. Intellectual Property</h2>
            <p>
            ...
            <h2 style={{ fontSize: "22px", fontWeight: 700, color: "#1C1A16", marginTop: "48px", marginBottom: "16px", letterSpacing: "-0.02em" }}>6. User Content</h2>
            <p>
            ...
            <h2 style={{ fontSize: "22px", fontWeight: 700, color: "#1C1A16", marginTop: "48px", marginBottom: "16px", letterSpacing: "-0.02em" }}>7. Limitation of Liability</h2>
            <p>
            ...
            <h2 style={{ fontSize: "22px", fontWeight: 700, color: "#1C1A16", marginTop: "48px", marginBottom: "16px", letterSpacing: "-0.02em" }}>8. Termination</h2>
            <p>
              We may terminate or suspend your account immediately, without prior notice, for any reason, including breach of these Terms.
            </p>

            <h2 style={{ fontSize: "22px", fontWeight: 700, color: "#1C1A16", marginTop: "48px", marginBottom: "16px", letterSpacing: "-0.02em" }}>9. Changes to Terms</h2>
            <p>
