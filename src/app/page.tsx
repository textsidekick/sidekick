            ...
            <div className="flex gap-6 overflow-x-auto testimonial-scroll px-6 md:px-24 pb-4">
              <div className="flex-shrink-0 w-[500px] h-[380px] rounded-2xl overflow-hidden relative group cursor-pointer">
                ...
                <div className="absolute inset-0 p-8 flex flex-col justify-between">
                  <div className="bg-white rounded-lg p-3 inline-block self-start shadow-lg">
                    <img src="/logos/eds.png" alt="EDS" className="h-12 w-auto object-contain" />
                  </div>
                  <div>
              ...
              <div className="flex-shrink-0 w-[500px] h-[380px] rounded-2xl overflow-hidden relative group cursor-pointer">
                ...
                <div className="absolute inset-0 p-8 flex flex-col justify-between">
                  <div className="bg-white rounded-lg p-3 inline-block self-start shadow-lg">
                    <img src="/logos/trinethra.png" alt="Trinethra" className="h-12 w-auto object-contain" />
                  </div>
                  <div>
              ...
              <div className="flex-shrink-0 w-[500px] h-[380px] rounded-2xl overflow-hidden relative group cursor-pointer">
                ...
                <div className="absolute inset-0 p-8 flex flex-col justify-between">
                  <div className="bg-white rounded-lg p-3 inline-block self-start shadow-lg">
                    <img src="/logos/jfm.png" alt="Jim Falk Motors" className="h-12 w-auto object-contain" />
                  </div>
                  <div>
