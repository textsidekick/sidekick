        ...
        <div className="max-w-5xl mx-auto px-6 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <span className="text-sm text-zinc-500">Q&A Test Interface</span>
            </div>
            ...
            >
              Manager Dashboard <ChevronRight className="w-4 h-4" />
            </Link>
          </div>
        </div>
      </nav>
        ...
        <div className="grid lg:grid-cols-3 gap-6 flex-1">
          ...
          <div className="lg:col-span-2 bg-white border border-zinc-200 rounded-2xl flex flex-col min-h-[600px]">
            ...
            <div className="p-4 border-b border-zinc-200 flex items-center gap-3">
              ...
              <div>
                <h2 className="font-semibold text-zinc-900">Ask Sidekick</h2>
                <p className="text-xs text-zinc-500">Test your documents with real questions</p>
              </div>
            </div>
            ...
            <div className="flex-1 p-4 overflow-y-auto space-y-4">
              {messages.length === 0 ? (
                <div className="h-full flex flex-col items-center justify-center text-center">
                  ...
                  <h3 className="font-semibold text-zinc-900 mb-2">Ready to help!</h3>
            ...
            <div className="p-4 border-t border-zinc-200">
              <div className="flex items-center gap-3">
                <input
                  ...
                  className="flex-1 px-4 py-3 bg-zinc-50 border border-zinc-200 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent disabled:opacity-50 disabled:cursor-not-allowed"
                />
                <button
                  onClick={handleSend}
          ...
          <div className="space-y-6">
              ...
              <div className="p-4">
                <label className="block">
                  <div className={`border-2 border-dashed rounded-xl p-6 text-center cursor-pointer transition-colors ${
                    ...
                    <p className="text-xs text-zinc-400 mt-1">PDF, TXT, DOC</p>
                  </div>
                  <input
                    type="file"
                    className="hidden"
            ...
            {documents.length > 0 && (
              <div className="bg-white border border-zinc-200 rounded-2xl p-4">
                <h3 className="font-semibold text-zinc-900 mb-3">Try asking</h3>
                <div className="space-y-2">
                  {suggestedQuestions.map((q, i) => (
                    <button
                      key={i}
                      onClick={() => setInput(q)}
                      className="w-full text-left px-3 py-2 bg-zinc-50 hover:bg-zinc-100 rounded-lg text-sm text-zinc-700 transition-colors"
                    >
                      {q}
                    </button>
                  ))}
