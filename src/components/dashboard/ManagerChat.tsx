  ...
  if (!isOpen) {
    return (
      <button
        ...
        className="fixed bottom-6 right-6 z-50 w-14 h-14 bg-[#0060F0] hover:bg-[#0050D0] text-white rounded-full shadow-lg flex items-center justify-center transition-all hover:scale-105"
        title="Ask Sidekick"
      >
  ...
  return (
    <div className="fixed bottom-6 right-6 z-50 w-[400px] h-[520px] bg-white rounded-2xl shadow-2xl border border-gray-200 flex flex-col overflow-hidden">
      ...
      <div className="flex items-center justify-between px-4 py-3 bg-[#0060F0] text-white">
        ...
        <button onClick={() => setIsOpen(false)} className="hover:bg-[#0050D0] rounded p-1 transition">
          <X className="w-5 h-5" />
        </button>
      </div>
      ...
      <form onSubmit={handleSubmit} className="px-4 py-3 border-t border-gray-200">
        <div className="flex items-center gap-2">
          ...
          <button
            ...
            className="p-2 bg-[#0060F0] text-white rounded-lg hover:bg-[#0050D0] disabled:opacity-50 disabled:cursor-not-allowed transition"
          >
