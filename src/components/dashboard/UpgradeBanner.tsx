    ...
    <div className="rounded-xl border border-[#0060F0]/20 bg-gradient-to-r from-[#0060F0]/5 to-amber-50 p-5">
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
        ...
        <button
          ...
          disabled={loading}
          className="flex items-center gap-2 px-5 py-2.5 bg-[#0060F0] text-white rounded-lg text-sm font-semibold hover:bg-[#0050D0] disabled:opacity-50 transition-colors flex-shrink-0"
        >
          {loading ? (
