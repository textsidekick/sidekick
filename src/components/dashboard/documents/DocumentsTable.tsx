...
const TYPE_BADGE_CLASSES: Record<string, string> = {
  PDF: 'bg-gray-100 text-gray-600 dark:bg-red-950 dark:text-red-400 border-transparent',
  Word: 'bg-gray-100 text-gray-600 dark:bg-blue-950 dark:text-[#0060F0] border-transparent',
  Excel: 'bg-gray-100 text-gray-600 dark:bg-green-950 dark:text-green-400 border-transparent',
