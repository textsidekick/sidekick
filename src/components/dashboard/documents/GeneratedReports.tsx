              ...
              >
                ...
                <div className="flex gap-2">
                  <button
                    ...
                    className="flex items-center gap-1.5 px-3 py-1.5 bg-[#0060F0] text-white rounded-lg text-xs font-medium hover:bg-[#004BB8] disabled:opacity-50 transition-colors"
                  >
                    {isGenerating ? (
                      <>
