    ...
    <section className="border-t border-[rgba(17,24,39,0.07)] px-6 py-28 md:px-10 md:py-36">
      <div className="mx-auto max-w-[1120px]">
        ...
        <div className="grid grid-cols-1 gap-5 md:grid-cols-2">
          ...
          <Reveal>
            <div className="flex h-full flex-col rounded-[24px] border border-[rgba(17,24,39,0.08)] p-9 md:p-11">
              <div className="mb-2 text-[11px] font-medium uppercase tracking-[0.16em] text-[rgba(17,24,39,0.4)]">
                The old way
              </div>
              <div
                className="mb-9 font-serif text-[rgba(17,24,39,0.35)]"
              ...
              <div className="flex flex-col">
                {OLD_STEPS.map((step, i) => (
                  ...
                  >
                    <span className="w-4 flex-shrink-0 font-mono text-[12px] text-[rgba(17,24,39,0.3)]">
                      {i + 1}
                    </span>
                    <span className="text-[15px] font-light text-[rgba(17,24,39,0.5)]">{step}</span>
                  </div>
                ))}
              </div>
            </div>
          ...
          <Reveal delay={120}>
            <div
              ...
              style={{
                background: "linear-gradient(160deg, #1e293b 0%, #111827 60%)",
                boxShadow: "0 1px 2px rgba(17,24,39,0.2), 0 24px 64px -24px rgba(17,24,39,0.45)",
              }}
            >
              <div
                aria-hidden
                ...
                style={{
                  background:
                    "radial-gradient(70% 55% at 85% 0%, rgba(0,96,240,0.16), transparent 65%)",
                }}
              />
              <div className="relative">
                <div className="mb-2 text-[11px] font-medium uppercase tracking-[0.16em] text-[rgba(248,249,252,0.45)]">
                  With Sidekick
                </div>
                <div
                ...
                <p className="m-0 max-w-[360px] text-[15px] font-light leading-[1.65] text-[rgba(248,249,252,0.6)]">
                  Any issue, any language. Work order created, right person assigned, issue
                  tracked — before the worker puts their phone away.
                </p>
                <div className="mt-9 inline-flex items-center gap-2 rounded-full border border-[rgba(255,255,255,0.14)] px-4 py-2 text-[13px] text-[rgba(255,255,255,0.7)]">
