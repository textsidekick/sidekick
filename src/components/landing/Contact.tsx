...
export default function Contact() {
  ...
  return (
    <section
      id="contact"
      className="border-t border-[rgba(17,24,39,0.07)] px-6 py-28 scroll-mt-24 md:px-10 md:py-36"
    >
      <div className="mx-auto grid max-w-[1120px] grid-cols-1 items-start gap-16 lg:grid-cols-[1fr_1.1fr] lg:gap-20">
        <Reveal>
          <Eyebrow>Get in touch</Eyebrow>
          <h2
            className="font-serif font-extrabold mt-5 mb-6 text-ink"
            style={{
          ...
          <p className="text-[16px] font-light leading-[1.6] text-[rgba(17,24,39,0.6)] m-0 mb-9 max-w-[460px]">
          ...
          <div className="flex flex-col gap-[18px]">
            {[
              ...
              <div key={c.l} className="flex gap-6 items-baseline">
                <div className="text-[11px] uppercase tracking-widest text-[rgba(17,24,39,0.45)] w-16 flex-shrink-0">
                  {c.l}
                </div>
        ...
        <Reveal delay={120}>
          <form
            onSubmit={onSubmit}
            className="flex flex-col gap-[18px] rounded-[20px] border border-[rgba(17,24,39,0.08)] p-9"
          ...
          >
            ...
            <div className="flex flex-col gap-1.5">
              <label className="text-xs text-[rgba(17,24,39,0.55)] font-medium">
              ...
              <textarea
                ...
                className="border border-[rgba(17,24,39,0.12)] bg-white rounded-lg px-3.5 py-3 text-sm text-ink outline-none resize-y focus:border-[rgba(0,96,240,0.4)]"
                style={{ transition: "border-color 0.2s ease" }}
              />
            </div>
            <div className="flex items-center justify-between gap-4 mt-1.5">
              <div className="text-xs text-[rgba(17,24,39,0.45)] max-w-[260px] leading-[1.4]">
                {state.kind === "success"
...
function Field({
  ...
  return (
    <div className="flex flex-col gap-1.5">
      <label className="text-xs text-[rgba(17,24,39,0.55)] font-medium" htmlFor={name}>
        {label}
      ...
      <input
        ...
        required={required}
        className="border border-[rgba(17,24,39,0.12)] bg-white rounded-lg px-3.5 py-2.5 text-sm text-ink outline-none focus:border-[rgba(0,96,240,0.4)]"
        style={{ transition: "border-color 0.2s ease" }}
      />
    </div>
  );
