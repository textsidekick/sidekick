...
export default function Footer() {
  return (
    <footer className="border-t border-[rgba(28,26,22,0.07)] px-6 pt-12 pb-10 md:px-10">
      <div className="mx-auto max-w-[1120px] flex flex-col md:flex-row justify-between items-start gap-12">
        <div className="max-w-[320px]">
          ...
          <p className="text-[13px] text-[rgba(28,26,22,0.5)] leading-[1.55] m-0 mb-4">
        ...
        <div className="flex gap-14 text-[13px]">
          <div>
            ...
            <div className="flex flex-col gap-2 text-[rgba(28,26,22,0.55)]">
              <a
      ...
      <div className="mx-auto max-w-[1120px] mt-8 pt-5 border-t border-[rgba(28,26,22,0.06)] flex justify-between text-xs text-[rgba(28,26,22,0.4)]">
