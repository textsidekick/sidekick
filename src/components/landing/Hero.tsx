...
export default function Hero() {
  return (
    <header style={{ position: "relative", height: 720, overflow: "hidden" }}>
      ...
      <div style={{ position: "relative", zIndex: 2, maxWidth: 1020, margin: "120px auto 0", padding: "0 24px", display: "grid", gridTemplateColumns: "minmax(0, 1fr) 272px", gap: 48, alignItems: "center", pointerEvents: "none" }}>
        <div>
          ...
          <h1 style={{ fontFamily: "var(--font-instrument-serif), Georgia, serif", fontWeight: 400, fontSize: 64, lineHeight: 1.05, color: "#FFFFFF", margin: "0 0 22px", textWrap: "balance" }}>
            Your workers text. <span style={{ color: "#4D8DFF" }}>Sidekick</span> handles the rest.
          </h1>
          <p style={{ fontSize: 16, lineHeight: 1.6, color: "rgba(255,255,255,0.88)", margin: "0 0 30px", maxWidth: 460, textWrap: "pretty" }}>
          ...
          <a className="lp-btn-blue" href={LINKS.bookDemo} target="_blank" rel="noopener noreferrer" style={{ pointerEvents: "auto", display: "inline-block", fontSize: 14, fontWeight: 500, padding: "13px 26px", borderRadius: 999 }}>
            Get a demo
          </a>
        </div>
        <div style={{ justifySelf: "end", width: 272, position: "relative" }}>
          <PhoneDemo />
        </div>
      </div>
    </header>
