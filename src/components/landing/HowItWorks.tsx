...
export default function HowItWorks() {
  return (
    <section id="product" className="border-t border-[rgba(28,26,22,0.07)] px-6 py-28 md:px-10 md:py-36">
        ...
        <Reveal>
          <div className="mb-16 flex flex-col gap-6 md:mb-20 md:flex-row md:items-end md:justify-between">
            <div>
              ...
              <h2
                className="mt-5 max-w-[560px] font-serif font-normal text-ink"
                style={{
            ...
            <p className="m-0 max-w-[300px] pb-1 text-[15px] font-light leading-relaxed text-[rgba(28,26,22,0.5)]">
              From the shop floor to a closed work order — with nobody chasing anybody down.
            </p>
          </div>
        </Reveal>

        <div className="grid grid-cols-1 gap-y-12 md:grid-cols-3 md:gap-y-0 md:divide-x md:divide-[rgba(28,26,22,0.08)]">
          {STEPS.map((s, i) => (
            <Reveal key={s.n} delay={i * 100}>
              ...
              >
                ...
                <h3
                  className="m-0 mb-3 font-serif font-normal text-ink"
                  style={{ fontSize: 26, lineHeight: 1.15, letterSpacing: "-0.015em" }}
                >
                  {s.title}
                </h3>
                <p className="m-0 max-w-[300px] text-[15px] font-light leading-[1.65] text-[rgba(28,26,22,0.6)]">
                  {s.body}
                </p>
              </div>
            </Reveal>
