...
export default function KnowledgeSection() {
  return (
    <section id="usecases" className="lp-knowledge-section" style={{ padding: "110px 36px" }}>
      <div style={{ maxWidth: 1080, margin: "0 auto" }}>
        <div className="lp-knowledge-header" style={{ textAlign: "center", marginBottom: 48 }}>
        ...
        <div className="lp-knowledge-grid" style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 24, alignItems: "stretch" }}>
          <div>
            <div className="lp-knowledge-demo" style={{ height: 480 }}>
