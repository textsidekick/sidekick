...
export default function Nav() {
  return (
    <nav className="lp-nav-shell" style={{ position: "fixed", top: 16, left: 0, right: 0, zIndex: 50, display: "flex", justifyContent: "center", padding: "0 24px", pointerEvents: "none" }}>
      <div className="lp-nav-inner" style={{ pointerEvents: "auto", display: "inline-flex", alignItems: "center", gap: 32, padding: "8px 8px 8px 20px", borderRadius: 999, border: "1px solid rgba(38,37,30,0.1)", background: "rgba(250,248,241,0.85)", backdropFilter: "blur(20px) saturate(1.5)", boxShadow: "0 6px 24px -8px rgba(28,26,22,0.12), 0 2px 6px -2px rgba(28,26,22,0.06)" }}>
        <div className="lp-nav-left" style={{ display: "flex", alignItems: "center", gap: 26 }}>
          ...
          <div className="lp-nav-links" style={{ display: "flex", alignItems: "center", gap: 20, fontSize: 14 }}>
