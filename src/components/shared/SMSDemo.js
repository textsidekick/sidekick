...
const SMSDemo = () => {
  ...
  const conversationFlow = [
    ...
    { type: 'incoming', text: 'Voice: Got it! Safety vests are in the warehouse entrance. Hard hats are required in Zone B.' },
    { type: 'outgoing', text: '안전 장비는 어디서 받나요?' },
    { type: 'incoming', text: '안전 장비는 창고 입구 옆 장비실에서 받으실 수 있습니다. Safety vest' },
  ];
